# AC Orchestration Protocol — the core

> **Truncation check:** The last line of this file should read `FULL FILE LOADED`. If you don't see it, reload or read in sections until you confirm the complete file.
>
> **How to use this file:** the **universal core** of how AC orchestrates every subagent it spins — the brief skeleton and its verbatim blocks, multi-trip loading, receipts, model pinning, the HARD RULE, and the rules that hold no matter what you are spinning. **Read this whole file before you spin anything.** Then read the one sub-doc for your target.
>
> **Do not edit this file without Justin's approval.** Propose changes; don't make them directly.

## The index — read the core, then YOUR target's sub-doc
...
| **OC** (ops) | the core alone — the skeleton covers it as written |
| **a generic subagent** (a path lookup) | the core alone — see "The generic-subagent exception" |

**Why this file was split (2026-08-11):** most spins are a DC or a QC, and those spinners were reading the AC-under-AC machinery and the team-agent substitutions as pure weight. **The split is by TARGET, not by importance** — nothing here is optional for the target it applies to.
