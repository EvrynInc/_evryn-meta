...
If you look at this list and reason that you don't need all of it for the task in <task>, IGNORE THAT INSTINCT. You do NOT know the full context of why this exact list was chosen. But an engineer who is senior to you — who DOES have that context — chose it **very intentionally**, because they know that if you skip even one file here you will be CONFIDENTLY WRONG in a way **you cannot currently see**. So DO NOT use your own judgment about what on this list to load or skip — YOU LACK THE CONTEXT TO MAKE THAT CALL. JUST LOAD EXACTLY WHAT IS LISTED HERE. If particular lines are listed, read exactly those lines; if no lines are listed, read the file in full, before you do anything in <task>:
