...
<mandatory_load>
**This trip has exactly one job: load.** You're being pre-loaded for a specific task, but you will not be told what work is coming — the task arrives separately, once this load is verified. Do not ask what it is, do not speculate about it, and do not begin any analysis, search, or investigation. Load the files, report what you loaded, stop.
