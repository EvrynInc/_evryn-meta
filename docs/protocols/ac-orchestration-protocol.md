...
|---|---|---|
| **Top-level AC** (talking to Justin) | ✅ **YES — and must** | `# ACP's read — <topic>` · **H1, name first.** Reserved exclusively for this. |
| **Sub-AC** (e.g. AC2 under ACP) | ✅ **YES — at `##`** | `## AC2's read — <topic>` · **never `#`.** |
| **DC · QC · OC · team agents** | 🚫 **BANNED — in any form** | Use `## For ACP — <topic>` · `## Flagging for AC2 — <topic>` · `## Needs ACT's attention — <topic>` |
