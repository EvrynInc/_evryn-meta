...
**Overview of the Evryn Platform.** Our customers may use the Services and their AI features to analyze and interact with their end users (“**End Users**”). As part of this, we may use AI to communicate with, and collect personal information, from End Users. The End User personal information we may collect includes, but is not limited to, email addresses and email communications between an End User and customers.
...
* **End User Data**. If you are an End User that interacts with Evryn on behalf of an Evryn customer, we may collect any personal information that you provide as part of this interaction. Additionally, if you are an Evryn Customer, you agree that Evryn may reach out to End Users on your behalf to provide the Services. 

* **Customer Email Data.** In order to use the Services, you agree to the automatic forwarding of emails. When Evryn is copied on an email thread, Evryn and its service providers will access the body or content of your emails or messages to provide the Services, understand context, and compose responses (“**Customer Email Data**”). You can revoke our access to your Customer Email Data at any time by removing Evryn from the applicable thread or stop forwarding emails to Evryn. However, please note that your withdrawal will only take effect for future processing. If you stop forwarding emails to Evryn, Evryn will not be able to continue providing the Services. 
...
* **Interactive Features**. We and others who use our Services may collect personal information that you submit or make available through our interactive features (e.g., social media pages). Any information you provide using the public sharing features of the Services will be considered “public.”
...
* **Cookie Notice (and Other Technologies).** We, as well as third parties, may use cookies, pixel tags, and other technologies (“**Technologies**”) to automatically collect personal information through your use of the Site.   
  ...
  *See “[Your Privacy Choices and Rights](#bookmark=id.p694qtbm9eet)” below to understand your choices regarding these Technologies.*
...
We may use personal information for marketing purposes, including to personalize and deliver marketing communications, promotions, and offers that may be of interest to you. If you are an End User, Evryn may also invite you to join the Evryn network.
...
We may engage in automated decision-making, including profiling. For example, Evryn may use automated processes to analyze End User communications and determine whether an End User may be a good fit for connection with an Evryn Customer. These automated assessments help us provide our Services, but they do not produce legal or similarly significant effects on individuals.
...
If you would like to exercise any of these rights, please contact us as set forth in “[Contact Us](#bookmark=id.rwbnp18mvvw2)” below. 
...
If you are a parent or guardian and believe that your child has uploaded personal information to the Services in violation of applicable law, you may contact us as described in “[Contact Us](#bookmark=id.rwbnp18mvvw2)” below.

9. # **CONTACT US**  {#contact-us}

Evryn is the controller of the personal information we process under this Privacy Notice. 

If you have any questions about our privacy practices or this Privacy Notice, or to exercise your rights as detailed in this Privacy Notice, please contact us at: contact@evryn.ai.
