...
- Hard rules checklist (never reveal user info, never disclose evaluations of named individuals ([ADR-010](docs/decisions/010-canary-principle-revised.md)), tone check)
