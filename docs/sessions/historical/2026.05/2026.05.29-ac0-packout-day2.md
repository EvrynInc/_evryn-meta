...
> **Backup reference (don't load by default):** the previous packout is at `docs/sessions/historical/2026.05/2026-05-27-ac0-packout-mid-integration-test.md`. That packout's framing has been fully absorbed into this one + the live session doc.
