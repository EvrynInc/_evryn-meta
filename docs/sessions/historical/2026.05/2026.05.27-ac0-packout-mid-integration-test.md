...
> **Backup reference (don't load by default):** the previous AC0's morning packout is at `docs/sessions/historical/2026.05/2026-05-27-ac0-packout-for-next-instance.md` if you ever need the prior session's framing — everything operational you need to drive should be in *this* doc.
