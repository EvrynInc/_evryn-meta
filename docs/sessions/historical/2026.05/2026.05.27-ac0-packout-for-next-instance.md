...
- `_evryn-meta/docs/sessions/historical/2026.05/2026-05-25-machine-switch-handoff.md` — moved here from `sessions/` (yesterday's predecessor doc; the still-relevant integration-test reading list is carried forward in this packout)
