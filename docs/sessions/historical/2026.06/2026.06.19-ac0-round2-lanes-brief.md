...
**AUDIT-DERIVED ADDITIONS (foundation audit, 2026-06-22 — fold into your build; full detail in `_evryn-meta/docs/working/2026.06.22-ac0-foundation-audit-findings.md`):**
...
- **Step 11b** (cache-prefix byte-identity) survives; **Step 11c** (the week-one measurement plan) is **done** and lives in `docs/working/2026.06.17-ac3-cache-measurement-plan.md` (kept live, mostly-clean AC work — soften the one SDK-TTL claim). It feeds sprint Step 59 (cache-partitioning SDK check). **Make the week-one measurement a tracked sprint Step** (per the sprint's process-tightening rule).
...
**AUDIT-DERIVED ADDITIONS (foundation audit, 2026-06-22 — findings doc: `_evryn-meta/docs/working/2026.06.22-ac0-foundation-audit-findings.md`):**
...
**Full design lives in `docs/working/2026.06.17-ac5-m1-stage2-design.md` (kept live — READ IT; it has a detailed clean-vs-suspect corruption addendum).**
...
**Design lives in `docs/working/2026.06.17-ac0-staging-launch-space.md` + `2026.06.17-ac4-staging-validation-playbook.md` (kept live — READ BOTH).**
