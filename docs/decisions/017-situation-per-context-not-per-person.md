...
Session S2 progressively refined this model. First, activity modules shifted to on-demand (Evryn determines activity from the conversation, not the trigger — see ADR-012 revised, ADR-015 revised). Then Justin identified two deeper problems:
...
- Session doc: `docs/sessions/2026-03-04-identity-writing-s2.md`
