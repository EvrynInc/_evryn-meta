...
5. **The contract negotiation window (May–July 2026) passed without a v0.3 and without a presence from us.** It was written here as an upcoming opportunity and expired unnoticed — which is the more useful lesson: **a dated opportunity in a strategy document needs an owner and a date, or it silently becomes history.** The underlying need has not gone away; a contracting industry is exactly where trusted connections matter most. The specific moment we named is spent.
...
**The backlog advantage.** **There is no accumulated v0.2 backlog** — no gatekeeper has ever forwarded. **The asset that does exist is a gatekeeper's own unprocessed inbox** — Mark's runs about eight months deep — and it is worth more than a few weeks of live triage for two reasons: the money arrives *at all*, without grinding to find those people one at a time; and **none of it was written for us**, which makes it the cleanest character record we will ever be handed. **It is reachable:** people don't expect same-day responses from someone that busy, and even months-late outreach reads as warm and human — *"I'm sorry it took me a bit to get back to you — Mark isn't available for this, but I'd love to help you find what you're looking for."* In a world where ghosting is the norm, a late response beats no response. ⚠️ **Treat it as a staged campaign, not one commitment:** Justin's stopping rule (2026-09-04) is to process the most recent months first, work backward in batches, and halt where the return falls off. **Economics and wave sizing live in `evryn-team-workspace/shared/projects/ops/unit-economics/2026.09.08-cast-off-outreach-economics.md` (Emma owns it); do not quote figures from here.**
...
2. **No competitor covers Evryn's combination — but a serious, well-capitalized entrant is building an adjacent product.** Every competitor we can see is single-domain; none has a compounding trust graph; none does trust-based pricing. **Overtone** — Hinge's founder, $15M from three investors per the SEC filing, with Match Group holding roughly a third of the cap table — is positioned closely enough that a cold reader could not reliably tell us apart. ⇒ **The risk was never that nobody wants what Evryn offers. It is that better-funded competitors converge on pieces of it and we become indistinguishable at the moment someone chooses.** See *Closest Threats*, above.
...
4. **No AI matchmaker is aimed at the creative industry, and Evryn has founder advantage there.** The gap is in this vertical only: Overtone is dating-only, but it launches in select markets this year, and nobody outside the company knows its retention or match quality. **The vertical is open; the category is not.**
