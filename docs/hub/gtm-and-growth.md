...
Invite-only positioning: "An invite-only platform where you get introduced to people who can change your career — but only if someone vouches for you." This triggers status-driven demand: "Do you know Evryn? Who can get me an invite?" Frames access as status, and status as prelude to serendipity.
...
People who emailed a gatekeeper but weren't the right mutual fit didn't opt in to hearing from Evryn. However, they initiated contact with someone in Evryn's ecosystem. CAN-SPAM is navigable (requires opt-out, not prior opt-in for email).
...
3. **Users as owners** — literally and philosophically user-owned
...
| **Gig & Freelance** | Transactional, noisy, commoditized (Upwork, Fiverr, Uber) | Long-term trust loops. Match once, come back forever. | Upwork layering AI; Uber scaling personalization |
...
> *For full SWOT analysis per category, see the Deep Research Report (Notion) and original Master Plan lines 1568-1670.*
