...
- **Runway:** ~$6,125 cash on hand. Burn varies dramatically by phase — ~$800/mo right now (agents paused, product not live), ramping to ~$3,250/mo at full steady state. At current burn, runway is ~7.5 months; at full steady state, ~2 months. Additional $15K available ($5K founder, $10K angel contingent on traction). Revenue target: late April / early May. **The critical constraint is Fenwick's deferred legal bill (~$45K) due August** — operating burn alone is manageable, but without ~$5K/mo average revenue from April onward, the August bill creates a cash crisis. Full burn profile and month-by-month projection in [business-model spoke](docs/hub/business-model.md).
