...
**Full design (the one home):** `_evryn-meta/docs/working/2026.06.17-ac1-step61-gatekeeper-address-resolution.md` — read it for the data model, resolution flow, escalation, the AC2/AC0 outbound model, and the proposed (auth-gated) ARCH/BUILD doc edits. Summary for convergence:
