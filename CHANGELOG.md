...
- **Mira brief queued (AC) for ADR-031 operator.md pass.** Brief at `_evryn-meta/docs/sessions/2026-04-29-mira-brief-operator-md-late-scope.md` — reframe scope determination as ongoing + add late-scope recovery as third named pattern. Justin passing brief to Mira.
